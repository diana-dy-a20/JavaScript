...
//Задача №3
// Знайти суми елементів у вказаній області,номери рядків (від половини до кінця, стовпці від 0 до половини
...
if (confirm('Start?')) {
	...
	let sum = 0
	for (let row = halfArrayLength; row < array.length; row++) {
		for (let element = 0; element < halfRow; element++) {
